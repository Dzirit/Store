...
namespace Store.Tests
{
    public class OrderTests
    {
        ...
        [Fact]
        public void GetItem_WithExisitingItem_ReturnItem()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1,3,10m),
        ...
        [Fact]
        public void GetItem_WithNonExisitingItem_ThrowsInvalidOperationException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1,3,10m),
        ...
        [Fact]
        public void RemoveItem_WithExisitingItem_RemovesItem()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1,3,10m),
        ...
        [Fact]
        public void RemoveItem_WithNonExisitingItem_ThrowsInvalidOperationException()
        {
            var order = new Order(1, new[]
            {
                new OrderItem(1,3,10m),
